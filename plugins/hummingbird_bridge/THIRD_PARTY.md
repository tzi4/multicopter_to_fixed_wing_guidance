...
plugin tags were removed from the inner model because the outer `swarm_drone_N`
...
from the inner model; the outer `swarm_drone_N` wrapper supplies the existing
