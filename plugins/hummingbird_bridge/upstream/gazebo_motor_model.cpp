...
void GazeboMotorModel::UpdateForcesAndMoments() {
  ...
  // Forces from Philppe Martin's and Erwan Salaun's 2010 IEEE Conference on Robotics and Automation
  // paper The True Role of Accelerometer Feedback in Quadrotor Control - \omega * \lambda_1 *
  // V_A^{\perp}
