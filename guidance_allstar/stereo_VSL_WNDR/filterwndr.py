...
def _mix_imm_initial_conditions_before(imm):
    """
    Apply the IMM model-mixing step before for the current measurement interval.
...
def predict_imm_over_dt(imm, dt, max_substep=None):
    ...
    _mix_imm_initial_conditions_before(imm)
